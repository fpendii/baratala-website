...
<div class="container mx-auto px-4 py-8">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">Tambah Uang Keluar</h2>

    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('admin.uang-keluar.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="flex gap-4">
                <button type="submit" class="bg-blue-600 text-white font-bold px-4 py-2 rounded-lg hover:bg-red-700">
                    Simpan
                </button>
